...
public class GoToSecondaryPositionTask extends Task<MCAVillagerEntity> {
    ...
    protected boolean shouldRun(ServerWorld serverWorld, MCAVillagerEntity villagerEntity) {
        ...
        if (optional.isPresent() && optional2.isPresent()) {
            ...
            if (!list.isEmpty()) {
                ...
                return this.chosenPosition != null && serverWorld.getRegistryKey() == this.chosenPosition.getDimension() && optional2.get().getPos().isWithinDistance(villagerEntity.getPos(), this.primaryPositionActivationDistance);
            }
        }
